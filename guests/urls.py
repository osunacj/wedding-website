...
from guests.views import GuestListView, home, test_email, save_the_date_preview, save_the_date_random, \
    export_guests, invitation, invitation_email_preview, invitation_email_test, rsvp_confirm, dashboard
